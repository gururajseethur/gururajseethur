...
<img src="https://img.shields.io/badge/CEH-certified-blue" alt="ceh" />
...
Currently building an automated penetration testing framework.

---

#### Toolbox

`Python` `FastAPI` `React` `Vite` `Docker Compose` `Ollama` `Traefik` `Cloudflare Tunnel` `Grafana` `Prometheus` `MITRE ATT&CK` `Wazuh` `Keycloak` `MISP` `Suricata` `Nmap` `Burp Suite`
...
- Working through TryHackMe alongside the BIA Master-Diploma — [63 rooms so far](https://tryhackme.com/p/Gururajseethur)
...
- **LinkedIn** — [in/gururaj-seethur](https://www.linkedin.com/in/gururaj-seethur)
